...
import { Lock, LogIn, AlertCircle, Loader2, Mail, Key } from "lucide-react";
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="flex flex-col gap-6">
          {error && (
            <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/20 flex items-center gap-3 text-red-400 text-xs text-center">
          ...
          {loginMethod === "google" ? (
            <button
              ...
              disabled={loading}
              className="btn-primary py-4 flex items-center justify-center gap-3 disabled:opacity-50"
            >
              {loading ? (
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-900/50 border border-white/5 rounded-xl pl-12 pr-5 py-4 outline-none focus:border-primary/50 transition-all text-sm"
                    required
                  />
                </div>
              </div>
          ...
          <button
            ...
            className="text-slate-400 text-sm hover:text-white transition-all flex items-center justify-center gap-2"
          >
            {loginMethod === "google" ? (
              <>
                <Mail size={16} />
